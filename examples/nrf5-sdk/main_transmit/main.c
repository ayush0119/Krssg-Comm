...
static nrf_esb_payload_t        tx_payload = NRF_ESB_CREATE_PAYLOAD(0, 0x01, 0x01, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,0x01, 0x01, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,0x01, 0x01, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00,0x01, 0x01, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00);
static nrf_esb_payload_t        rx_payload;

#define OP_QUEUES_SIZE          3
#define APP_TIMER_PRESCALER     NRF_SERIAL_APP_TIMER_PRESCALER

void uart_recieve(arr[]);
...
uint8_t a[5];
ret_code_t ret;
ret = nrf_serial_read(&serial_uart,arr,sizeof(a),NULL,1000); 
}
